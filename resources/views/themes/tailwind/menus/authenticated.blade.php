<div x-data="{ open: false }" class="flex h-full md:flex-1">
    <div class="flex-1 hidden h-full space-x-8 md:flex">
        <a href="{{ route('wave.dashboard') }}" class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none border-b-2 @if(Request::is('dashboard')){{ 'border-b-2 border-blue-500 text-gray-900 focus:border-indigo-700' }}@else{{ 'text-gray-500 border-transparent hover:border-gray-300 hover:text-gray-700 focus:text-gray-700 focus:border-gray-300' }}@endif">Dashboard</a>
        ...
        <a href="{{ route('wave.templates.index') }}" class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none border-b-2 @if(Request::is('templates')){{ 'border-b-2 border-blue-500 text-gray-900 focus:border-indigo-700' }}@else{{ 'text-gray-500 border-transparent hover:border-gray-300 hover:text-gray-700 focus:text-gray-700 focus:border-gray-300' }}@endif">Note Templates</a>
