            ...
            <div class="px-8 pt-6 pb-8 space-y-6">
                <div class="flex items-center justify-between mt-1">
                    ...
                    <div class="text-gray-500 mr-2">
                        <button @click="mobileMenuOpen = false" type="button" class="inline-flex items-center justify-center p-2 text-white transition duration-150 ease-in-out rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500">
                            <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="black">
                ...
                <div>
                    <nav class="grid row-gap-8">
                        ...
                        <a href="{{ route('wave.templates.index') }}" class="flex items-center p-3 m-3 space-x-3 transition duration-150 ease-in-out rounded-md hover:bg-gray-50">
