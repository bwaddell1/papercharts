<div id="deleteVisitModal" x-data x-init="$watch('$store.deleteVisitModal.open', value => {
    if (value === true) { document.body.classList.add('overflow-hidden') } else { document.body.classList.remove('overflow-hidden'); }
});" x-show="$store.deleteVisitModal.open"
    class="fixed inset-0 z-10 z-30 overflow-y-auto">
    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div x-show="$store.deleteVisitModal.open" @click="$store.deleteVisitModal.open = false;"
        ...
        <div x-show="$store.deleteVisitModal.open" x-transition:enter="ease-out duration-300"
                ...
                <div class="mt-3 flex justify-between items-center sm:mt-5">
                    ...
                    <div class="mt-2">
                        <svg class="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            viewBox="0 0 16 16" fill="none" @click="$store.deleteVisitModal.open = false;">
