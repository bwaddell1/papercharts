                ...
                <tbody>
                    @foreach ($visits as $key => $visit)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="px-2 py-4">
                                <a href="{{route('wave.visits.fill_out', $visit->id)}}"
                                ...
                                <div class="cursor-pointer" data-dropdown-toggle="edit_dropdown{{ $visit->id }}">
                                    ...
                                    <div id="edit_dropdown{{ $visit->id }}"
                                        ...
                                        <ul class="py-2 text-xs text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <button wire:click="handleOpenQuickNoteModal({{ $visit->id }})"
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full">Complete
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex items-start justify-between p-4 border-b rounded-t">
                            <h3 class="text-xl font-semibold text-gray-900">
                                Complete Visit Electronically {{$generate_note_id}}
                            </h3>
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                @else
                                    <div class="w-full lg:w-5/12 px-4" wire:ignore>
                                        <p class="text-2xl text-bold text-center" style="padding: 12px 0;">Generating</p>
